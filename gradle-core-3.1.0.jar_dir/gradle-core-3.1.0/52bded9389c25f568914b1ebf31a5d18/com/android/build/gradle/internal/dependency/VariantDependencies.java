...
/*     */       {
/* 222 */         for (Configuration configuration : testedVariantDependencies.sourceSetImplementationConfigurations) {
...
/*     */       {
/* 252 */         for (Configuration configuration : testedVariantDependencies.sourceSetRuntimeConfigurations) {
...
/*     */   {
/* 464 */     return new Builder(project, errorReporter, variantConfiguration);
/*     */   }
/*     */   
/*     */   private VariantDependencies(String variantName, Configuration compileClasspath, Configuration runtimeClasspath, Collection<Configuration> sourceSetRuntimeConfigurations, Collection<Configuration> sourceSetImplementationConfigurations, Configuration apiElements, Configuration runtimeElements, Configuration annotationProcessorConfiguration, Configuration metadataElements, Configuration metadataValuesConfiguration, Configuration wearAppConfiguration, Configuration bundleElements)
/*     */   {
/* 480 */     this.variantName = variantName;
/* 481 */     this.compileClasspath = compileClasspath;
/* 482 */     this.runtimeClasspath = runtimeClasspath;
/* 483 */     this.sourceSetRuntimeConfigurations = sourceSetRuntimeConfigurations;
/* 484 */     this.sourceSetImplementationConfigurations = sourceSetImplementationConfigurations;
/* 485 */     this.apiElements = apiElements;
/* 486 */     this.runtimeElements = runtimeElements;
/* 487 */     this.annotationProcessorConfiguration = annotationProcessorConfiguration;
/* 488 */     this.metadataElements = metadataElements;
/* 489 */     this.metadataValuesConfiguration = metadataValuesConfiguration;
/* 490 */     this.wearAppConfiguration = wearAppConfiguration;
/* 491 */     this.bundleElements = bundleElements;
/*     */   }
/*     */   
/*     */   public String getName() {
/* 495 */     return variantName;
/*     */   }
/*     */   
/*     */   public Configuration getCompileClasspath()
/*     */   {
/* 500 */     return compileClasspath;
/*     */   }
/*     */   
/*     */   public Configuration getRuntimeClasspath()
/*     */   {
/* 505 */     return runtimeClasspath;
/*     */   }
/*     */   
/*     */   public Collection<Dependency> getIncomingRuntimeDependencies()
/*     */   {
/* 510 */     ImmutableList.Builder<Dependency> builder = ImmutableList.builder();
/* 511 */     for (Configuration classpath : sourceSetRuntimeConfigurations) {
/* 512 */       builder.addAll(classpath.getIncoming().getDependencies());
/*     */     }
...
/* 554 */     return 
/*     */     
/* 556 */       MoreObjects.toStringHelper(this).add("name", variantName).toString();
/*     */   }
/*     */ }

/* Location:
 * Qualified Name:     com.android.build.gradle.internal.dependency.VariantDependencies
