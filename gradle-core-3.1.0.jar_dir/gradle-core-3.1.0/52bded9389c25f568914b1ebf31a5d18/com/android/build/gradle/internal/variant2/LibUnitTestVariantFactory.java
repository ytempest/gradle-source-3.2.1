...
/*    */   
/*    */   @NotNull
/* 34 */   public VariantType getGeneratedType() { return generatedType; } @NotNull
/* 35 */   public List<VariantType> getTestedBy() { return testedBy; } @Nullable
/* 36 */   public VariantType getTestTarget() { return testTarget; }
/*    */   
/*    */   public LibUnitTestVariantFactory()
/*    */   {
/* 34 */     generatedType = VariantType.UNIT_TEST;
/* 35 */     LibUnitTestVariantFactory localLibUnitTestVariantFactory = this;List localList = CollectionsKt.emptyList();testedBy = localList;
/* 36 */     testTarget = VariantType.LIBRARY;
/*    */   }
/*    */   
/*    */   @NotNull
...
/*    */   {
/* 49 */     Intrinsics.checkParameterIsNotNull(extension, "extension");Intrinsics.checkParameterIsNotNull(variantProperties, "variantProperties");Intrinsics.checkParameterIsNotNull(productFlavorOrVariant, "productFlavorOrVariant");Intrinsics.checkParameterIsNotNull(buildTypOrVariant, "buildTypOrVariant");Intrinsics.checkParameterIsNotNull(variantExtensionProperties, "variantExtensionProperties");Intrinsics.checkParameterIsNotNull(commonVariantProperties, "commonVariantProperties");Intrinsics.checkParameterIsNotNull(variantDispatcher, "variantDispatcher");Intrinsics.checkParameterIsNotNull(issueReporter, "issueReporter");return (SealableVariant)new UnitTestVariantImpl(
/* 50 */       VariantType.UNIT_TEST, 
/* 51 */       variantProperties, 
/* 52 */       productFlavorOrVariant, 
/* 53 */       buildTypOrVariant, 
/* 54 */       variantExtensionProperties, 
/* 55 */       commonVariantProperties, 
/* 56 */       variantDispatcher, 
/* 57 */       issueReporter);
/*    */   }
/*    */   
/*    */   @Nullable
/* 61 */   public String computeApplicationId(@NotNull ProductFlavorOrVariant mergedFlavor, @Nullable String appIdSuffixFromFlavors) { Intrinsics.checkParameterIsNotNull(mergedFlavor, "mergedFlavor"); if (appIdSuffixFromFlavors != null) {
/* 62 */       return Intrinsics.stringPlus(mergedFlavor.getInstrumentationOptions().getApplicationId(), appIdSuffixFromFlavors);
/*    */     }
/*    */     
/* 65 */     return mergedFlavor.getInstrumentationOptions().getApplicationId();
/*    */   }
/*    */ }

/* Location:
 * Qualified Name:     com.android.build.gradle.internal.variant2.LibUnitTestVariantFactory
