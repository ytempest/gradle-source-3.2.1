...
/*    */ 
/*    */ @Metadata(mv={1, 1, 9}, bv={1, 0, 2}, k=1, d1={"\000 \n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\002\b&\030\0002\0020\001:\001\tB\005¢\006\002\020\002J\020\020\003\032\0020\0042\006\020\005\032\0020\006H'J\030\020\003\032\0020\0042\006\020\005\032\0020\0062\006\020\007\032\0020\bH\007¨\006\n"}, d2={"Lcom/android/build/gradle/internal/scope/BuildElementActionScheduler;", "", "()V", "into", "Lcom/android/build/gradle/internal/scope/BuildElements;", "type", "Lcom/android/build/gradle/internal/scope/TaskOutputHolder$TaskOutputType;", "folder", "Ljava/io/File;", "Synchronous", "gradle-core"})
/*    */ public abstract class BuildElementActionScheduler
/*    */ {
/*    */   @NotNull
/*    */   public abstract BuildElements into(@NotNull TaskOutputHolder.TaskOutputType paramTaskOutputType)
/*    */     throws BuildException;
/*    */   
/*    */   @NotNull
/*    */   public final BuildElements into(@NotNull TaskOutputHolder.TaskOutputType type, @NotNull File folder)
/*    */     throws BuildException
/*    */   {
/* 32 */     Intrinsics.checkParameterIsNotNull(type, "type");Intrinsics.checkParameterIsNotNull(folder, "folder");return into(type).save(folder); }
/*    */   
...
/*    */   public static final class Synchronous extends BuildElementActionScheduler { @NotNull
/* 36 */     public final BuildElements getElements() { return elements; } @NotNull
/* 37 */     public final Function2<ApkInfo, File, File> getAction() { return action; } public Synchronous(@NotNull BuildElements elements, @NotNull Function2<? super ApkInfo, ? super File, ? extends File> action) { this.elements = elements;this.action = action; }
/*    */     
/*    */     @NotNull
...
/* Location:
 * Qualified Name:     com.android.build.gradle.internal.scope.BuildElementActionScheduler
